...
function getExpansions(callback) {
    return __awaiter(this, void 0, void 0, function () {
        var database, expansions, docs, exp, _i, docs_1, doc;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, expansions.find().toArray()];
                case 2:
                    docs = _a.sent();
                    exp = [];
...
function createGame(gameID, ownerName, expansions, callback) {
